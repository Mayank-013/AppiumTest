...
public class RegisterHeiferCattle extends PropertyManager{
	
	public String registerHeiferCattle(String url,String token,String scenario) throws Exception {
		
		Properties prop = new PropertyManager().getProps();
		
		RestAssured.baseURI = url;
		String abstractname = prop.getProperty("RegisterHeifer"); //
		...
		JSONObject dataObject = exceldata.readCase("RegisterHeifer",scenario,filepath);
