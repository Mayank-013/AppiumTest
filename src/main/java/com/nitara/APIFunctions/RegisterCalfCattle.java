...
public class RegisterCalfCattle extends PropertyManager{
	
	public String registerCalfCattle(String url,String token,String scenario) throws Exception {
		
		Properties prop = new PropertyManager().getProps();
		
		RestAssured.baseURI = url;
		String abstractname = prop.getProperty("RegisterCalf"); //
		...
		JSONObject dataObject = exceldata.readCase("RegisterCalf",scenario,filepath);
